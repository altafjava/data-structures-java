...
have no intersection at all, return null. The test cases are generated such that there are no cycles anywhere in the entire linked structure.
...
From the head of A, it reads as [4,1,8,4,5]. From the head of B, it reads as [5,6,1,8,4,5]. There are 2 nodes before the intersected node
...
//		ListNode headB = ListNodeUtil.createListNode(15);
		...
		ListNodeUtil.print(headA);
		ListNodeUtil.print(headB);
		Intersect intersect = new Intersect();
		ListNode intersectionNode = intersect.getIntersectionNode2(headA, headB);
