...
//		Integer arr[] = { 10, 5, 15, 3, 7, null, 18 }, low = 7, high = 15;
		Integer arr[] = { 10, 5, 15, 3, 7, 13, 18, 1, null, 6 }, low = 6, high = 10;
		TreeNode root = TreeNodeUtil.createTreeNodeFromArray(arr);
		RangeSum rangeSum = new RangeSum();
		int sum = rangeSum.rangeSumBST(root, low, high);
