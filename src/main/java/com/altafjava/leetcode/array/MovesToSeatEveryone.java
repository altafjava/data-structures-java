...
public class MovesToSeatEveryone {
	public static void main(String[] args) {
		MovesToSeatEveryone movesToSeatEveryone = new MovesToSeatEveryone();
//		int[] seats = { 4, 1, 5, 9 }, students = { 1, 3, 2, 6 };
//		int[] seats = { 3, 1, 5 }, students = { 2, 7, 4 };
		int[] seats = { 2, 2, 6, 6 }, students = { 1, 3, 2, 6 };
		int minMovesToSeat = movesToSeatEveryone.minMovesToSeat(seats, students);
		System.out.println(minMovesToSeat);
	}
