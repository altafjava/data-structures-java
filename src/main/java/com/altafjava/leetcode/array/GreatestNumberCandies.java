...
the ith kid has, and an integer extraCandies, denoting the number of extra candies that you have. Return a boolean array result of
...
//		int[] candies = { 12, 1, 12 };
//		int extraCandies = 10;
		List<Boolean> list = greatestNumberCandies.kidsWithCandies2(candies, extraCandies);
